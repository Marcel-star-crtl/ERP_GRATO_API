...
router.get('/', 
    requireRoles('admin', 'supply_chain', 'manager', 'supervisor', 'finance', 'employee', 'it', 'hr', 'buyer', 'hse'),
...
router.patch('/:projectId/progress', 
    requireRoles('admin', 'supply_chain', 'manager', 'supervisor', 'employee', 'it', 'hr', 'buyer', 'hse'),
...
// // NEW: Supervisor milestone routes
// router.get('/my-milestones',
//     requireRoles('admin', 'supply_chain', 'supervisor', 'manager'),
//     projectController.getSupervisorMilestones
// );

// router.get('/:projectId/milestones/:milestoneId',
//     requireRoles('admin', 'supply_chain', 'supervisor', 'manager', 'employee'),
//     projectController.getMilestoneDetails
// );
