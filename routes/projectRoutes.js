...
router.get('/my-milestones', projectController.getSupervisorMilestones);

// Department projects
router.get('/department/:department', projectController.getProjectsByDepartment);

// Milestone details (standalone)
router.get('/milestones/:milestoneId/details', async (req, res) => {
  try {
...
// Submit for approval
router.post('/:projectId/submit', projectController.submitProjectForApproval);
...
// Risks
router.post('/:projectId/risks', projectController.addProjectRisk);
router.patch('/:projectId/risks/:riskId/status', projectController.updateRiskStatus);

// Issues
router.post('/:projectId/issues', projectController.addProjectIssue);
router.patch('/:projectId/issues/:issueId/resolve', projectController.resolveIssue);

// Change requests
router.post('/:projectId/change-requests', projectController.addChangeRequest);
...
// Meetings
router.post('/:projectId/meetings', projectController.logProjectMeeting);

// Milestones
router.get('/:projectId/milestones/:milestoneId', projectController.getMilestoneDetails);
router.post('/:projectId/milestones/:milestoneId/complete', projectController.completeMilestone);

// Sub-milestones
router.get('/:projectId/milestones/:milestoneId/hierarchy', subMilestoneController.getMilestoneHierarchy);
router.post('/:projectId/milestones/:milestoneId/sub-milestones', subMilestoneController.createSubMilestone);
router.put('/:projectId/milestones/:milestoneId/sub-milestones/:subMilestoneId', subMilestoneController.updateSubMilestone);
router.delete('/:projectId/milestones/:milestoneId/sub-milestones/:subMilestoneId', subMilestoneController.deleteSubMilestone);
router.patch('/:projectId/milestones/:milestoneId/sub-milestones/:subMilestoneId/progress', subMilestoneController.updateSubMilestoneProgress);
router.post('/:projectId/milestones/:milestoneId/sub-milestones/:subMilestoneId/complete', subMilestoneController.completeSubMilestone);
...
router.patch('/:projectId/progress', projectController.updateProjectProgress);
