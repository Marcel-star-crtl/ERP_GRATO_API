...
// router.post('/justification/:requestId/decision', 
//   authMiddleware, 
//   async (req, res) => {
//     await cashRequestController.processJustificationDecision(req, res);
//   }
// );

// router.get('/justifications/supervisor/pending', 
//   authMiddleware, 
//   async (req, res) => {
//     await cashRequestController.getSupervisorJustifications(req, res);
//   }
// );
