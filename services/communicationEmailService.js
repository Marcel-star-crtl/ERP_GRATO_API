...
/**
 * Generate professional email HTML template - OUTLOOK COMPATIBLE
 */
              ...
              <table border="0" cellpadding="5" cellspacing="0" width="100%">
                <tr>
                  ...
                  <td width="30%" align="center" rowspan="2" style="vertical-align: middle;">
                    <img src="cid:company-logo" alt="Grato Logo" style="display: block; width: 120px; height: 90px; margin: 0 auto;" />
                  </td>
...
//                     <img src="cid:company-logo" alt="Grato Logo" style="display: block; width: 120px; height: 100px; margin: 0 auto;" />
//                   </td>
//                 </tr>
//               </table>
//               <table border="0" cellpadding="5" cellspacing="0" width="100%">
//                 <tr>
//                   <td width="50%" style="color: #666666; font-size: 12px; font-family: Arial, Helvetica, sans-serif;">
//                     <strong>From:</strong> Grato Engineering Global
//                   </td>
//                   <td width="50%" align="right" style="color: #666666; font-size: 12px; font-family: Arial, Helvetica, sans-serif;">
//                     <strong>Sent:</strong> ${new Date(communication.sentAt || Date.now()).toLocaleString()}
//                   </td>
//                 </tr>
//                 <tr>
//                   <td style="color: #666666; font-size: 12px; font-family: Arial, Helvetica, sans-serif;">
//                     <strong>Type:</strong> ${communication.messageType}
//                   </td>
//                   <td align="right" style="color: #666666; font-size: 12px; font-family: Arial, Helvetica, sans-serif;">
//                     <strong>ID:</strong> COM-${communication._id.toString().slice(-6).toUpperCase()}
//                   </td>
//                 </tr>
//               </table>
...
//                 <tr>
//                   <td align="center">
//                     <img src="cid:company-logo" alt="Grato Logo" style="display: block; max-width: 200px; height: auto; margin: 0 auto 15px auto;" />
//                     <h1 style="color: #ffffff; margin: 0; font-size: 24px; font-weight: bold; font-family: Arial, Helvetica, sans-serif;">
//                       ${icon} Internal Communications
//                     </h1>
//                   </td>
...
//           <!-- Header -->
//           <tr>
//             <td align="center" style="padding: 30px; background-color: #667eea; border-radius: 8px 8px 0 0;">
//               <table border="0" cellpadding="0" cellspacing="0" width="100%">
//                 <tr>
//                   <td align="center">
//                     <h1 style="color: #ffffff; margin: 0; font-size: 24px; font-weight: bold; font-family: Arial, Helvetica, sans-serif;">
