// ============================================
// config/actionItemApprovalChain.js - COMPLETE REPLACEMENT
// ============================================
...
// /**
//  * Get supervisor for action item approval
//  * Returns the immediate supervisor who needs to approve the task
//  */
// const getTaskSupervisor = (employeeName, department) => {
//   console.log(`\n=== FINDING TASK SUPERVISOR ===`);
//   console.log(`Employee: ${employeeName}`);
//   console.log(`Department: ${department}`);
...
//     const executive = DEPARTMENT_STRUCTURE['Executive'];
//     if (executive) {
//       console.log(`✓ Employee is Department Head - Supervisor: ${executive.head}`);
//       return {
//         name: executive.head,
//         email: executive.headEmail,
//         department: 'Executive'
...
//       const executive = DEPARTMENT_STRUCTURE['Executive'];
//       if (executive) {
//         console.log(`✓ Employee is Department Head of ${deptKey} - Supervisor: ${executive.head}`);
//         return {
//           name: executive.head,
//           email: executive.headEmail,
//           department: 'Executive'
...
//     for (const [pos, data] of Object.entries(dept.positions)) {
//       if (pos === employeeData.supervisor || data.name === employeeData.supervisor) {
//         console.log(`✓ Supervisor: ${data.name} (${pos})`);
//         return {
//           name: data.name,
//           email: data.email,
//           department: employeeDepartmentName
...
//   // Check if supervisor is department head
//   if (dept.head === employeeData.supervisor || employeeData.supervisor.includes('Head')) {
//     console.log(`✓ Supervisor: ${dept.head} (Department Head)`);
//     return {
//       name: dept.head,
//       email: dept.headEmail,
//       department: employeeDepartmentName
