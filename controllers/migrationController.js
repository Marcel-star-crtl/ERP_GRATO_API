...
// /**
//  * 1. Migrate Available Stock (Creates/Updates Items)
//  */
...
//         let item = await Item.findOne({ code: materialCode }).session(session);
        
//         const itemData = {
//           code: materialCode,
//           description: row['Material Name'] || 'Unknown',
//           category: row['CATEGORY'] || 'General',
//           unitOfMeasure: row['UOM'] || 'Each',
//           stockQuantity: parseFloat(row['ON HAND']) || 0,
//           standardPrice: parseFloat(row['UP']) || parseFloat(row['TP']) || 0,
//           averageCost: parseFloat(row['TP']) || parseFloat(row['UP']) || 0,
