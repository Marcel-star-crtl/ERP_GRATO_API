...
// /**
//  * Record inbound transaction with item instances
//  */
...
//       comment,
//       receivedBy,
//       itemInstances // NEW: Array of instance data
//     } = req.body;
...
//     console.log('Item from catalog:', itemFromCatalog.code, itemFromCatalog.description);
...
//     // NOTE: We now allow multiple inventory records with same code
//     // Use a combination approach: try exact match first, then create new
...
//     if (!inventoryItem) {
//       console.log('Creating new inventory record:', itemFromCatalog.code);
...
//     // NEW: Create inventory instances if provided
...
//     if (item.stockQuantity < parseFloat(quantity)) {
//       return res.status(400).json({
//         success: false,
//         message: `Insufficient stock. Available: ${item.stockQuantity}, Requested: ${quantity}`
//       });
//     }
...
//     // Update item stock
//     item.stockQuantity -= parseFloat(quantity);
...
//     });
//   } catch (error) {
//     console.error('Record outbound error:', error);
//     res.status(500).json({
//       success: false,
