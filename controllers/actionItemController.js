...
//       filter.projectId = null;
//     } else if (view === 'my-approvals') {
//       // Supervisors see tasks pending their approval
//       if (user.role === 'supervisor' || user.role === 'admin' || user.role === 'supply_chain') {
//         // No filter - will be filtered by status in controller or frontend
//       } else {
//         filter.assignedTo = req.user.userId;
//       }
//     } else {
...
//     // Determine task status and assignee
//     let taskStatus = 'Pending Approval';
//     let taskAssignedTo = req.user.userId;
//     let supervisor = null;
...
//       taskStatus = 'Not Started'; // Assigned tasks start as Not Started
//       supervisor = {
//         name: creator.fullName,
//         email: creator.email,
//         department: creator.department
...
//         status: taskStatus === 'Pending Approval' ? 'pending' : 'approved',
//         approvedBy: taskStatus === 'Pending Approval' ? null : req.user.userId,
//         approvedAt: taskStatus === 'Pending Approval' ? null : new Date()
//       },
//       completionApproval: {
//         status: 'not_submitted'
//       }
...
//     actionItem.logActivity(
//       'created', 
//       req.user.userId, 
//       `Task created by ${creator.fullName}${assignedUser ? ` and assigned to ${assignedUser.fullName}` : ' - pending supervisor approval'}`
//     );
...
//       // Task assigned - notify assigned user
//       try {
//         const assignedUserForEmail = await User.findById(assignedTo);
//         await sendActionItemEmail.taskAssigned(
//           assignedUserForEmail.email,
//           assignedUserForEmail.fullName,
//           creator.fullName,
//           title,
//           description,
//           priority,
...
//           project ? project.name : null
//         );
//         console.log(`✅ Assignment notification sent to: ${assignedUserForEmail.email}`);
//       } catch (emailError) {
//         console.error('Failed to send assignment notification:', emailError);
//       }
//     } else {
...
//     res.status(201).json({
//       success: true,
//       message: assignedTo && assignedTo !== req.user.userId ? 'Task created and assigned to user' : 'Task created and sent to your supervisor for approval',
//       data: actionItem
//     });
...
//       actionItem.createdBy._id.equals(req.user.userId) ||
//       ['supply_chain', 'admin'].includes(user.role);
