  ...
  try {
    ...
    try {
      ...
      const rfq = new RFQ({
        ...
        deliveryLocation: deliveryLocation || requisition.deliveryLocation,
        specialRequirements,
        evaluationCriteria: evaluationCriteria || { quality: 40, cost: 35, delivery: 25 },
...
//     // Select the quote
//     quote.select(reason, req.user.userId);
//     await quote.save();
...
//     // Update requisition status
//     const requisition = quote.requisitionId;
//     requisition.status = 'procurement_complete';
//     requisition.procurementDetails.selectedVendor = quote.supplierId.name;
...
//         subject: `Congratulations! Your Quote Has Been Selected`,
//         html: `
//           <h2>Quote Selected</h2>
//           <p>Dear ${quote.supplierId.name},</p>
//           <p>We are pleased to inform you that your quote for "${rfq.title}" has been selected.</p>
//           <p><strong>Quote Amount:</strong> XAF ${quote.totalAmount.toLocaleString()}</p>
//           <p>Our team will contact you shortly to finalize the purchase order.</p>
//         `
//       });
//     } catch (emailError) {
//       console.error('Failed to notify winning supplier:', emailError);
//     }
