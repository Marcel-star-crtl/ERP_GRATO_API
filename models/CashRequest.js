...
const CashRequestSchema = new mongoose.Schema({
  ...
  status: {
    type: String,
    enum: [
      'pending_supervisor',           // Level 1: Immediate supervisor approval
      'pending_departmental_head',    // Level 2: Departmental head approval  
      'pending_head_of_business',     // Level 3: Head of business approval
      'pending_finance',              // Level 4: Finance approval and disbursement
      'approved',                     // Approved by finance, ready for disbursement
      'denied',                       // Rejected at any level
      'disbursed',                    // Money disbursed, awaiting justification
      'justification_pending_supervisor',     // Justification submitted, supervisor review
      'justification_pending_departmental_head', // Justification escalated to dept head
      'justification_pending_finance',        // Justification final review by finance
      'justification_rejected',               // Justification rejected
      'completed'                            // Full cycle completed
    ],
