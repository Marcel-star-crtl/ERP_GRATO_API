...
// NEW: Method for Supply Chain assignment (auto-approves at Supply Chain level)
supplierInvoiceSchema.methods.assignBySupplyChain = function(department, assignedByUserId, comments) {
  ...
  console.log(`Supplier Invoice ${this.invoiceNumber} assigned to ${department} by Supply Chain. First approver: ${this.approvalChain[0]?.approver.name}`);
};
