...
//   status: {
//     type: String,
//     enum: ['pending', 'completed', 'cancelled', 'partially-completed'],
//     default: 'pending'
//   },
...
//     const prefix = this.transactionType === 'inbound' ? 'INB' : 
//                    this.transactionType === 'outbound' ? 'OUT' : 
//                    this.transactionType === 'transfer' ? 'TRF' : 'ADJ';
    
//     // Count existing transactions of this type today
//     const count = await this.constructor.countDocuments({
//       transactionType: this.transactionType,
//       createdAt: {
...
// StockTransactionSchema.virtual('displayId').get(function() {
